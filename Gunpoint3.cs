...
public class Gunpoint3 : MonoBehaviour
{
    ...
    public static int totalammo = 150;
    ...
    void Update()
    {
        ...
        if (currentAmmo <= 0 && totalammo <= 0)
        {
            ...
            gun3img.color = Color.red;
            gun33img.color = Color.red;
        ...
        if (totalammo >= 0)
        {
            ...
            gun3img.color = Color.white;
            gun33img.color = Color.white;
        }
